...
export default function Contact() {
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText('mvijaykumar2820@gmail.com');
    setEmailCopied(true);
      ...
      <div className="flex min-h-screen w-full items-center justify-center pt-44 align-middle text-[8.6vw] xs:text-[5.6vw]">
        <div className="p-12 xs:w-1/2 xs:p-0">
          ...
          <div className="flex justify-between uppercase">
            ...
            <Link href={'https://www.linkedin.com/in/vijaykumarmoodavath/'}>
          ...
          <div className="flex justify-between uppercase">
            ...
            <Link href={'https://github.com/mvijaykumar2820'}>
              <TextDisperse setBackground={setBackground}>
                <p>→Github</p>
              </TextDisperse>
            </Link>
