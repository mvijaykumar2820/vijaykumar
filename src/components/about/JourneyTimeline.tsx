...
const journeyData: TimelineItem[] = [
  {
    ...
    description:
      'Pursuing an Engineering degree. Learning core computer science concepts, algorithms, and full-stack development.',
    highlight: true
  },
  {
    year: '2024',
    ...
    description:
      'Implementing full-stack projects using React, Node.js, and Firebase. Focusing on modern UI and interactions.'
  },
  {
    year: '2023',
    ...
    description:
      'Built React Native applications like the Mini Food Ordering App and Travel Itinerary App.'
  }
];
