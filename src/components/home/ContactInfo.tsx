    ...
    >
      <div className="w-full bg-foreground pt-[150px] sm:max-w-[1800px]">
        ...
        <div className="mt-6 flex gap-5 sm:mx-[100px]">
          <RoundedButton>mvijaykumar2820@gmail.com</RoundedButton>
        </div>
        ...
        <div className="mt-20 flex flex-col justify-between p-5 2xs:mt-52 sm:mx-[100px] sm:mt-48 sm:flex-row">
          <p className="min-w-screen mb-5 text-base sm:max-w-xs">
            Full Stack Web Developer | React & React Native | Machine Learning Enthusiast |
            Passionate about building modern, interactive web experiences.
          </p>
          ...
          <div className="flex items-end gap-2">
            ...
            <Magnetic>
              <Link
                href="https://github.com/mvijaykumar2820"
            ...
            <Magnetic>
              <Link
                href="https://www.linkedin.com/in/vijaykumarmoodavath/"
                className={animatedUnderlineStyle}
              >
                Linkedin
              </Link>
