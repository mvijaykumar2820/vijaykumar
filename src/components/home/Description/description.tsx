...
export default function Description() {
  const phrase1 =
    'Full Stack Web Developer with a passion for modern UI and\n' +
    'interactions.\n\n ';

  const phrase2 =
    'Specializing in React, Next.js, and animation-heavy UI concepts. ' +
    'I build clean, minimal, and performant web applications.';
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        >
          Engineering student at MVSR Engineering College.
        </motion.p>
        <motion.p
          variants={opacity}
          animate={isInView ? 'open' : 'closed'}
        ...
        >
          Focused on Full-Stack Development, React Native, and Machine Learning.
        </motion.p>
